...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cpf = jUsuario.getText();
        String senha = String.valueOf(jSenha.getPassword());
        
        if(cpf.isEmpty() || senha.isEmpty()){
            JOptionPane.showMessageDialog(this, "Informe o CPF e a sneha");
            return;
        }
        
        FuncionariosDAO funcionarioDAO = new FuncionariosDAO();
        
        if(funcionarioDAO.consultarPorCPFeSenha(cpf, senha) != null){
